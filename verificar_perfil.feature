Feature: Verificando se o cliente é VIP

Scenario: Um cliente reconhecido pode ser VIP
    ...
    When a probabilidade de ser vip for 100 porcento
    Then 1 cliente deve ser movido para a lista de vips
    When a foto C:\Users\Win10\Documents\GitHub\loja-inteligente-python-bdd\faces\darlene1.jpg de um visitante for capturada
    Then um(a) cliente deve ser reconhecido(a)
    When a probabilidade de ser vip for 0 porcento
    Then 0 cliente deve ser movido para a lista de vips