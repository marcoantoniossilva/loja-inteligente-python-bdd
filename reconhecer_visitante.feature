...
Scenario: Um cliente chega ao hospital e deve ser reconhecido por uma camera
...
Scenario: Uma pessoa que nao e cliente chega ao hospital e nao deve ser reconhecida
    Given o ambiente seja preparado com sucesso
